...
class QT_QTPROPERTYBROWSER_EXPORT QtYFileBoxPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
    QtYFileBoxPropertyManager(QObject *parent = 0);
    ~QtYFileBoxPropertyManager();

    QString value(const QtProperty *property) const;
    bool isReadOnly(const QtProperty *property) const;
    bool isFilePathType(const QtProperty *property) const;

public Q_SLOTS:
    void setValue(QtProperty *property, const QString &val);
    void setReadOnly(QtProperty *property, bool readOnly);
    void setPathType(QtProperty *property, const bool &val);

Q_SIGNALS:
    void valueChanged(QtProperty *property, const QString &val);
    void readOnlyChanged(QtProperty *property, const bool &);
    void pathTypeChanged(QtProperty *property, const bool &);
...
protected:
    ...
    virtual void uninitializeProperty(QtProperty *property);
private:
    QtYFileBoxPropertyManagerPrivate *d_ptr;
    Q_DECLARE_PRIVATE(QtYFileBoxPropertyManager)
    Q_DISABLE_COPY(QtYFileBoxPropertyManager)
};
